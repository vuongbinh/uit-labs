...
| +tfidf | 213 | 0.3694 | 26.99 | 3.828 | 1.379 | 0.7573 |
...
| +tfidf | -0.0450 | -10.85% | -3.35 | -0.368 | +0.0291 |
...
- `area` — 22.53% of total gain
- `tgt_district_name` — 20.67% of total gain
- `tgt_ward_name` — 9.13% of total gain
- `tfidf_w_5` — 8.43% of total gain
- `freq_district_name` — 3.42% of total gain
- `bedroom_count` — 3.40% of total gain
- `tgt_province_name` — 2.69% of total gain
- `frontage_width` — 2.52% of total gain
- `freq_property_type_name` — 2.50% of total gain
- `floor_count` — 2.27% of total gain
- `freq_province_name` — 1.60% of total gain
- `text_area_m2` — 1.53% of total gain
- `tfidf_w_1` — 1.42% of total gain
- `bathroom_count` — 1.25% of total gain
- `freq_ward_name` — 1.09% of total gain
